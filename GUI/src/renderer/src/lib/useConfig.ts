...
export function useConfig() {
    ...
    // 更新配置（自动保存）
    const setConfig = useCallback((updater: Partial<AppConfig> | ((prev: AppConfig) => AppConfig)) => {
        setConfigState(prev => {
    ...
    // 更新高级设置
    const setAdvanced = useCallback((updates: Partial<AppConfig['advanced']>) => {
        setConfig(prev => ({
            ...prev,
    ...
    // 更新输出设置
    const setOutput = useCallback((updates: Partial<AppConfig['output']>) => {
        setConfig(prev => ({
            ...prev,
